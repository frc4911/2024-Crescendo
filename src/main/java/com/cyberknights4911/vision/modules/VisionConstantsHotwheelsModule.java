...
@Module
public interface VisionConstantsHotwheelsModule {
  ...
  @Provides
  @IntoSet
  public static CameraConstants providesCameraConstants3() {
  ...
  @Provides
  @IntoSet
  public static CameraConstants providesCameraConstants4() {
    return CameraConstantsBuilder.builder()
        .name("photonvision4")
