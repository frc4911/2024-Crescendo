...
public class Climb extends SubsystemBase {
  ...
  private final LoggedTunableNumber lockToggleTime;
  ...
  @Inject
  public Climb(
      ClimbConstants constants, ClimbIO climbIO, LoggedTunableNumberFactory numberFactory) {
    super();
    this.climbIO = climbIO;
    winchConstant = constants.gearRatio() * WINCH_RADIUS;
    kP = numberFactory.getNumber("Climb/kP", constants.feedBackValues().kP());
    kD = numberFactory.getNumber("Climb/kD", constants.feedBackValues().kD());
    forwardLimit = numberFactory.getNumber("Climb/forwardLimit", constants.forwardLimit());
    backwardLimit = numberFactory.getNumber("Climb/backwardLimit", constants.backwardLimit());
    extendPosition = numberFactory.getNumber("Climb/extendPosition", constants.extendPosition());
    retractPosition = numberFactory.getNumber("Climb/retractPosition", constants.retractPosition());
    lockToggleTime = numberFactory.getNumber("Climb/LockToggleTime", constants.lockToggleTime());
