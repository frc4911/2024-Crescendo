...
/**
 * Listener interface for receiving callbacks when the robot enters different states. Note that
 * there is no method for onRobotInit because that is when the listener is instantiated.
 */
